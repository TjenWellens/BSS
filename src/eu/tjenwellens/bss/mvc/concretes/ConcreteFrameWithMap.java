...
public class ConcreteFrameWithMap extends javax.swing.JFrame implements TickObserver
{
    ...
    {//GEN-HEADEREND:event_mouseClickOnMapPanel
        ...
        int row = evt.getY() / panelWidth;
        int col = evt.getX() / panelHeight;
        ...
        {// CHAARGEEEE!!!!
            if (evt.isShiftDown())
            {
                ...
                ci.addCommand(new DecorateCommand(cr, pass, Decoration.DESTROY, row, col, ToolFactory.createTool(ToolType.HAMER, Material.HOUT)));
            } else
            {
        ...
        {// graffity
            ...
            if (evt.isShiftDown())
            {
                ...
                ci.addCommand(new DecorateCommand(cr, pass, Decoration.BUILD, row, col, ToolFactory.createTool(ToolType.TRUWEEL, Material.HOUT)));
            ...
            } else
            {
                ...
                ci.addCommand(new DecorateCommand(cr, pass, Decoration.PAINT, row, col, ToolFactory.createTool(ToolType.PENSEEL, Material.HOUT)));
            }
        }
