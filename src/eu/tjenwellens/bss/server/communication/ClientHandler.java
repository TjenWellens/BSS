...
import eu.tjenwellens.bss.data.commands.init_exit.ErrLogin;
import eu.tjenwellens.bss.data.commands.init_exit.ErrQuickplay;
import eu.tjenwellens.bss.data.commands.init_exit.ErrSignUp;
import eu.tjenwellens.bss.data.commands.init_exit.InitStream;
import eu.tjenwellens.bss.data.commands.init_exit.Logout;
import eu.tjenwellens.bss.data.commands.init_exit.OKLogin;
import eu.tjenwellens.bss.data.commands.init_exit.OkQuickplay;
import eu.tjenwellens.bss.data.commands.init_exit.OkSignUp;
    ...
    private void manageInput() throws IOException, ClassNotFoundException
    {
        ...
        while (linkOpen && this.checkForInputStream.available() > 0)
        {
            ...
            } else if (playerId >= 0)    // player is logged in
            {
                ...
                {
                    DataItem di = ((ChooseWeapon) leesObject).getWeapon();
